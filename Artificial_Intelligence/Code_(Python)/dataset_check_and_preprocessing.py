...
data = pandas.read_csv('/content/drive/MyDrive/DaeguCatholicUniversity_Software_Creative_Design_01/DataSet/Unprocessed_Data/Unprocessed_URL_Data_03(URLhaus).csv',
                   usecols=['url', 'type'], encoding='ISO-8859-1')  # OR Using encoding='cp949'
...
def domain_registration_length(url):
    return numpy.random.randint(1, 5) # 1 for short-term, 5 for long-term
...
output_path = '/content/drive/MyDrive/DaeguCatholicUniversity_Software_Creative_Design_01/DataSet/Processed_Data/Processed_URL_Data_04(URLhaus).csv'
